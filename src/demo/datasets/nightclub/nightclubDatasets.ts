...
const products: NightclubProduct[] = [
  { id: 'bottle-1', category: 'Botellas', name: 'Vodka premium 750 ml', price: 420, preparationArea: 'Barra', stockUnits: 18, inventoryMode: 'recipe', recipe: [{ inventoryId: 'vodka-ml', quantity: 750 }] },
  { id: 'cocktail-1', category: 'Tragos / Cócteles', name: 'Cóctel de la casa', price: 48, preparationArea: 'Barra', stockUnits: 80, inventoryMode: 'recipe', recipe: [{ inventoryId: 'vodka-ml', quantity: 60 }, { inventoryId: 'mixer-ml', quantity: 140 }] },
  { id: 'beer-1', category: 'Cervezas', name: 'Cerveza lager', price: 28, preparationArea: 'Directo', stockUnits: 96, inventoryMode: 'unit', inventoryId: 'beer-unit', recipe: [{ inventoryId: 'beer-unit', quantity: 1 }] },
  { id: 'mixer-1', category: 'Mixers / Energizantes', name: 'Energizante', price: 32, preparationArea: 'Directo', stockUnits: 72, inventoryMode: 'unit', inventoryId: 'mixer-can', recipe: [{ inventoryId: 'mixer-can', quantity: 1 }] },
  { id: 'combo-1', category: 'Combos', name: 'Botella + 6 mixers', price: 560, preparationArea: 'Barra', stockUnits: 12, inventoryMode: 'recipe', recipe: [{ inventoryId: 'vodka-ml', quantity: 750 }, { inventoryId: 'mixer-can', quantity: 6 }] },
  { id: 'snack-1', category: 'Snacks', name: 'Tabla snack', price: 65, preparationArea: 'Barra', stockUnits: 24, inventoryMode: 'unit', inventoryId: 'snack-unit', recipe: [{ inventoryId: 'snack-unit', quantity: 1 }] },
  { id: 'courtesy-1', category: 'Cortesías', name: 'Cortesía de la casa', price: 0, preparationArea: 'Directo', stockUnits: 20, inventoryMode: 'unit', inventoryId: 'courtesy-unit', recipe: [{ inventoryId: 'courtesy-unit', quantity: 1 }] },
]
...
export function createFullNightclubDataset(): NightclubDataset {
  ...
  const accountOne: NightclubAccount = { id: 'night-account-vip-1', serviceTarget: { type: 'table', tableId: 'night-table-vip-1' }, tableId: 'night-table-vip-1', customerId: 'night-customer-1', openedAt: '2026-09-25T21:10:00Z', openedBy: 'Servicio Valeria', status: 'open', subtotal: 680, payments: [], rounds: [
    { id: 'round-vip-1', sequence: 1, createdAt: '2026-09-25T21:12:00Z', status: 'ready', items: [{ id: 'ri-1', productId: 'bottle-1', name: 'Vodka premium 750 ml', quantity: 1, unitPrice: 420, lineTotal: 420, preparationArea: 'Barra' }, { id: 'ri-2', productId: 'mixer-1', name: 'Energizante', quantity: 4, unitPrice: 32, lineTotal: 128, preparationArea: 'Directo' }] },
    { id: 'round-vip-2', sequence: 2, createdAt: '2026-09-25T22:05:00Z', status: 'preparing', items: [{ id: 'ri-3', productId: 'cocktail-1', name: 'Cóctel de la casa', quantity: 2, unitPrice: 48, lineTotal: 96, preparationArea: 'Barra' }, { id: 'ri-4', productId: 'beer-1', name: 'Cerveza lager', quantity: 1, unitPrice: 28, lineTotal: 28, preparationArea: 'Directo' }, { id: 'ri-5', productId: 'courtesy-1', name: 'Cortesía de la casa', quantity: 2, unitPrice: 0, lineTotal: 0, preparationArea: 'Directo' }, { id: 'ri-6', productId: 'snack-1', name: 'Tabla snack', quantity: 1, unitPrice: 8, lineTotal: 8, preparationArea: 'Barra' }] },
  ] }
  const accountTwo: NightclubAccount = { id: 'night-account-lounge-1', serviceTarget: { type: 'table', tableId: 'night-table-lounge-1' }, tableId: 'night-table-lounge-1', openedAt: '2026-09-25T21:45:00Z', openedBy: 'Servicio Marco', status: 'open', subtotal: 245, payments: [], rounds: [{ id: 'round-lounge-1', sequence: 1, createdAt: '2026-09-25T21:48:00Z', status: 'preparing', items: [{ id: 'ri-7', productId: 'cocktail-1', name: 'Cóctel de la casa', quantity: 3, unitPrice: 48, lineTotal: 144, preparationArea: 'Barra' }, { id: 'ri-8', productId: 'beer-1', name: 'Cerveza lager', quantity: 2, unitPrice: 28, lineTotal: 56, preparationArea: 'Directo' }, { id: 'ri-9', productId: 'snack-1', name: 'Tabla snack', quantity: 1, unitPrice: 45, lineTotal: 45, preparationArea: 'Barra' }] }] }
